...
{
    private static $_resource = 'products';
     ...
     * @return \SimpleXMLElement|string
     */
    public function create(array $data, $xmlCallback=null)
    {
        return $this->wsCreate(self::$_resource, $data, $xmlCallback);
    }
     ...
     * @return \SimpleXMLElement|string
     */
    public function update($data, $xmlCallback)
    {
        $id = $data['id'];
