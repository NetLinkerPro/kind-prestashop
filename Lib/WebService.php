...
use NetLinker\KindPrestaShop\Config;
use NetLinker\KindPrestaShop\PSWebservice;
...
class WebService
{
     ...
     * @return SimpleXMLElement|string
     */
    protected function wsCreate($service, array $fields, $xmlCallback=null)
    {
        /**
        ...
        $postXml  = preg_replace('/ xlink:href=".*?"/', '', $xml->asXML());
        $opt = array(
            'resource' => $service,
     ...
     * @return SimpleXMLElement|string
     */
    protected function wsUpdate($service, $id, array $fields, $xmlCallback=null)
    {
        /**
         * @var $xml \SimpleXMLElement
         */
